              ...
              <Card>
                <CardBody>
                  ...
                  <div id="usa-vectormap" style={{ height: "420px" }}>
                    <Vector value="us_aea" width="500" color="#0bb197" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                <CardBody>
                  ...
                  <div id="india-vectormap" style={{ height: "420px" }}>
                    <Vector value="in_mill" width="500" color="#0bb197" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                <CardBody>
                  ...
                  <div id="australia-vectormap" style={{ height: "420px" }}>
                    <Vector value="au_mill" width="500" color="#0bb197" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                <CardBody>
                  ...
                  <div id="canada-vectormap" style={{ height: "420px" }}>
                    <Vector value="ca_lcc" width="500" color="#0bb197" />
                  </div>
                </CardBody>
              </Card>
            </Col>
